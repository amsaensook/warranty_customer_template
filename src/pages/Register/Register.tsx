...
const Register: React.FC = () => {
  ...
  useEffect(() => {
    if (createStatus === "success") {
      ...
      // navigate(`${import.meta.env.VITE_APP_PUBLIC_URL}/Main`);
      console.log('ssssss =ssss',Register?.data.data);
      mutate(Register?.data.data);
                ...
                <Form.Item
                  ...
                  <div style={{
                    ...
                    <Button
                      type="ghost"
                      htmlType="submit"
                      icon={<RollbackOutlined className="relative bottom-1" />}
                      loading={isLoading}
                      className="w-full"
                      style={{
                        display: 'flex',
                      ...
                      href={`${import.meta.env.VITE_APP_PUBLIC_URL}${`/Main`}`}
                      >
                      ย้อนกลับ
                    </Button>
